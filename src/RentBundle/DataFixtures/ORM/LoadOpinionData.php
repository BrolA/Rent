...
class LoadOpinionData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $opinion1->setDataDodania(new \DateTime(2013-12-16));
        ...
        $opinion2->setDataDodania(new \DateTime(2014-12-16));
        ...
        $opinion3->setDataDodania(new \DateTime(2015-12-16));
        ...
        $opinion4->setDataDodania(new \DateTime(2012-12-16));
        ...
        $opinion5->setDataDodania(new \DateTime(2013-12-15));
